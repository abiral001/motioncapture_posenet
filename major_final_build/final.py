...
if __name__ == '__main__':
    parser = ArgumentParser(description = 'Motion Capture using Posenet')
    parser.add_argument('-m', '--model', type = str, default = 'human-pose-estimation-3d.pth')
    ...
    canvas_3d = np.zeros((720, 1200, 3), dtype=np.uint8)
